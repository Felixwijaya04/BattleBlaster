...
public:	
	...
	UPROPERTY(VisibleAnywhere) UNiagaraComponent* TrailParticles;
	UPROPERTY(EditAnywhere) UNiagaraSystem* HitParticles;
	UPROPERTY(EditAnywhere) float Damage = 25;
	UPROPERTY(EditAnywhere) USoundBase* LaunchSound;
	UPROPERTY(EditAnywhere) USoundBase* HitSound;
	UPROPERTY(EditAnywhere) TSubclassOf<UCameraShakeBase> HitCameraShakeClass;
