...
public:
	...
	UPROPERTY(VisibleAnywhere) USceneComponent* BulletSpawnPoint;

	UPROPERTY(EditAnywhere) TSubclassOf<AProjectile> ProjectileClass;
	UPROPERTY(EditAnywhere) UNiagaraSystem* DeathParticles;
	UPROPERTY(EditAnywhere) USoundBase* ExplosionSound;
	UPROPERTY(EditAnywhere) TSubclassOf<UCameraShakeBase> DeathCameraShakeClass;
