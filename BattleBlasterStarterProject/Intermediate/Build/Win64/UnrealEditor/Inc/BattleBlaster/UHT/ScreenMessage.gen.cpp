...
struct Z_Construct_UClass_UScreenMessage_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_LevelNameBlock_MetaData[] = {
		{ "BindWidget", "" },
		{ "Category", "ScreenMessage" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "ScreenMessage.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_EnemyNumTracker_MetaData[] = {
		{ "BindWidget", "" },
		{ "Category", "ScreenMessage" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "ScreenMessage.h" },
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_LevelNameBlock;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_EnemyNumTracker;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UScreenMessage_Statics::NewProp_LevelNameBlock = { "LevelNameBlock", nullptr, (EPropertyFlags)0x0010000000080009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UScreenMessage, LevelNameBlock), Z_Construct_UClass_UTextBlock_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_LevelNameBlock_MetaData), NewProp_LevelNameBlock_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UScreenMessage_Statics::NewProp_EnemyNumTracker = { "EnemyNumTracker", nullptr, (EPropertyFlags)0x0010000000080009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UScreenMessage, EnemyNumTracker), Z_Construct_UClass_UTextBlock_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_EnemyNumTracker_MetaData), NewProp_EnemyNumTracker_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UScreenMessage_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UScreenMessage_Statics::NewProp_LevelNameBlock,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UScreenMessage_Statics::NewProp_EnemyNumTracker,
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Project_Files_BattleBlasterStarterProject_V1_zip__2_46_Mb__BattleBlasterStarterProject_Source_BattleBlaster_ScreenMessage_h__Script_BattleBlaster_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UScreenMessage, UScreenMessage::StaticClass, TEXT("UScreenMessage"), &Z_Registration_Info_UClass_UScreenMessage, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UScreenMessage), 402925224U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Project_Files_BattleBlasterStarterProject_V1_zip__2_46_Mb__BattleBlasterStarterProject_Source_BattleBlaster_ScreenMessage_h__Script_BattleBlaster_3814280967(TEXT("/Script/BattleBlaster"),
	Z_CompiledInDeferFile_FID_Unreal_Project_Files_BattleBlasterStarterProject_V1_zip__2_46_Mb__BattleBlasterStarterProject_Source_BattleBlaster_ScreenMessage_h__Script_BattleBlaster_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Project_Files_BattleBlasterStarterProject_V1_zip__2_46_Mb__BattleBlasterStarterProject_Source_BattleBlaster_ScreenMessage_h__Script_BattleBlaster_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
